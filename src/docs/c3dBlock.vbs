...
strNewText = Replace(strText,"var c3dBlock","import InstructionTab from './optimize/InstructionTab';" & vbCrLf &"import Instruction from './optimize/Instruction';" & vbCrLf &"import Type from './optimize/Type';" & vbCrLf & "export var c3dBlock" )
